...
The UI wasn't the enemy. It was the wrong constraint for the wrong problem. The right answer wasn't more UI or less UI. It was matching the constraint to the job. Sometimes that's a Kanban board. Sometimes it's a text at midnight.
